...
const VERSION = 'miroir 2026-08-04.3';
...
const CLE_VALIDE = /^(acces|annees|secteurs|config_admin|topos|staffs|veille|protocoles|annuaire|planning_\d{4}|affectations_\d{4}|indispos_\d{4})$/;
